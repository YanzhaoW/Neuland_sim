...
class R3BNeulandMapped2Cal : public FairTask
{
  ...
  public:
    ...
    inline void SubtractTriggerTime(Bool_t subtract = kTRUE) { fSubtractTriggerTime = subtract; }
  ...
  private:
    ...
    Bool_t fSubtractTriggerTime; /**< Enable / Disable trigger time subtraction in cal level */
